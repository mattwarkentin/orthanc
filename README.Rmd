...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/orthanc)](https://CRAN.R-project.org/package=orthanc)
...
+ Asynchronous client support and parallelization using [`mirai`](https://mirai.r-lib.org)

+ Encapsulated object-oriented representations of hierarchical DICOM resources using [`R6`](https://r6.r-lib.org)
